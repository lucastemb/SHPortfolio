...
function AboutMe() {
  ...
  return (
    <div className="flex flex-col bg-aboutme h-screen">
      <Navbar />

      {/* Info Section */}
      <div className="flex flex-row justify-center h-full items-center">
        <div className="flex flex-col text-white font-sans font-semibold w-[35%] mr-5">
          <h2 className="text-7xl text-textColor"> About Me </h2>
          <p className="font-normal text-textColor"> {aboutme['description']}</p>
