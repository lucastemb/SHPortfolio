...
function AboutMe() {
  return (
    ...
    {/* Info Section */}
    <div className="flex flex-row align-center justify-around h-full items-center">
    <div className="flex flex-col text-white font-sans font-semibold"> 
    ...
    <div className="w-56 h-56 overflow-hidden rounded-[50%] flex justify-self-start">
