  ...
  return (
    <div className="bg-white rounded-lg mt-4 mb-4">
      <div className="flex lg:flex-row md:flex-row flex-col justify-around h-full">
        <div className="flex flex-row lg:w-[25%] md:w-[25%] p-4">
        <div className="flex justify-center items-center w-full">  
        <img className="max-h-80 place-self-center"src={props.img}></img>
        </div>
        </div>
        <div className="flex justify-center text-center lg:text-right md:text-right lg:w-[25%] md:w-[25%] align-right p-8 lg:hidden md:hidden">
        <p className="text-[#001F5B] text-sm lg:text-base md:text-base"> {props.dates}</p>
        </div> 
        <span className="flex flex-col lg:w-[50%] md:w-[50%] p-8"> 
        ...
        <div className="flex justify-center text-right w-[25%] align-right p-8 hidden lg:flex md:flex">
